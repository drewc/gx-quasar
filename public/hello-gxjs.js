...
// File generated by Gambit v4.9.3
// Link info: (409003 (js ()) "hello" (("hello")) (module_register peps make_interned_symbol glo check_procedure_glo poll pollcount r0 r1 ffi wrong_nargs nargs) (gxjs#alert) (hello#) () #f)

g_cst0_G_hello = g_make_interned_symbol("gxjs#alert");
...
g_bb1_hello_23_ = function () { // entry-point
  ...
  exports.Hello = (arg) => {
     var hello_fn = g_scm2host(g_bb2_hello_23_)
     hello_fn('Hello ' + arg)
  }
  g_r1 = void 0;
  return g_r0;
...
g_bb2_hello_23_ = function () { // entry-point
  if (g_nargs !== 1) {
    return g_wrong_nargs(g_bb2_hello_23_);
  }
  if (--g_pollcount === 0) {
    return g_poll(g_bb3_hello_23_);
  } else {
    g_nargs = 1;
    return g_check_procedure_glo(g_glo["gxjs#alert"],g_cst0_G_hello)();
  }
};
...
g_bb3_hello_23_.id = 2;
g_bb3_hello_23_.parent = g_bb1_hello_23_;


g_bb1_hello_23_.ctrlpts = [g_bb1_hello_23_,g_bb2_hello_23_,g_bb3_hello_23_];
...
// File generated by Gambit v4.9.3
// Link info: (409003 (js ()) "hello-gxjs-rt" (("hello-gxjs-rt")) (module_register peps r3 make_interned_symbol glo check_procedure_glo string check_procedure r2 r1 ffi poll pollcount r0 sp stack wrong_nargs nargs) (##program-descr error) (gxjs#gambit-module-name gxjs#console.log hello-gxjs-rt# gxjs#alert gxjs#init-gambit-module gxjs#init-gambit-program) () #f)
...
g_cst0_G_hello_2d_gxjs_2d_rt = new G_ScmString([78,111,32,105,110,105,116,32,102,111,114,32]);

g_cst1_G_hello_2d_gxjs_2d_rt = g_make_interned_symbol("error");

g_bb1_hello_2d_gxjs_2d_rt_23_ = function () { // entry-point
  if (g_nargs !== 0) {
    return g_wrong_nargs(g_bb1_hello_2d_gxjs_2d_rt_23_);
  }
  g_stack[g_sp+1] = g_r0;
  ++g_sp;
  if (--g_pollcount === 0) {
    return g_poll(g_bb2_hello_2d_gxjs_2d_rt_23_);
  } else {
    g_r0 = g_bb3_hello_2d_gxjs_2d_rt_23_;
    g_nargs = 0;
    return g_bb1_gxjs_23_init_2d_gambit_2d_program();
  }
};


g_bb1_hello_2d_gxjs_2d_rt_23_.id = 0;
g_bb1_hello_2d_gxjs_2d_rt_23_.parent = g_bb1_hello_2d_gxjs_2d_rt_23_;
g_bb1_hello_2d_gxjs_2d_rt_23_.nfree = -1;
g_bb1_hello_2d_gxjs_2d_rt_23_._name = g_make_interned_symbol("hello-gxjs-rt#");
g_bb1_hello_2d_gxjs_2d_rt_23_.ctrlpts = null;
g_bb1_hello_2d_gxjs_2d_rt_23_.info = false;

g_bb2_hello_2d_gxjs_2d_rt_23_ = function () {
  g_r0 = g_bb3_hello_2d_gxjs_2d_rt_23_;
  g_nargs = 0;
  return g_bb1_gxjs_23_init_2d_gambit_2d_program();
};
...
g_bb2_hello_2d_gxjs_2d_rt_23_.id = 1;
g_bb2_hello_2d_gxjs_2d_rt_23_.parent = g_bb1_hello_2d_gxjs_2d_rt_23_;

g_bb3_hello_2d_gxjs_2d_rt_23_ = function () { // return-point
  gx_gambit_module_init = (g_scm2host(g_bb4_hello_2d_gxjs_2d_rt_23_))
  g_r1 = void 0;
  --g_sp;
...
g_bb3_hello_2d_gxjs_2d_rt_23_.id = 2;
g_bb3_hello_2d_gxjs_2d_rt_23_.parent = g_bb1_hello_2d_gxjs_2d_rt_23_;
g_bb3_hello_2d_gxjs_2d_rt_23_.fs = 1;
g_bb3_hello_2d_gxjs_2d_rt_23_.link = 1;

g_bb4_hello_2d_gxjs_2d_rt_23_ = function () { // entry-point
  if (g_nargs !== 1) {
    return g_wrong_nargs(g_bb4_hello_2d_gxjs_2d_rt_23_);
  }
  if (--g_pollcount === 0) {
    return g_poll(g_bb5_hello_2d_gxjs_2d_rt_23_);
  } else {
    g_nargs = 1;
    return g_bb1_gxjs_23_init_2d_gambit_2d_module();
  }
};


g_bb4_hello_2d_gxjs_2d_rt_23_.id = 3;
g_bb4_hello_2d_gxjs_2d_rt_23_.parent = g_bb1_hello_2d_gxjs_2d_rt_23_;
g_bb4_hello_2d_gxjs_2d_rt_23_.nfree = -1;

g_bb5_hello_2d_gxjs_2d_rt_23_ = function () {
  g_nargs = 1;
  return g_bb1_gxjs_23_init_2d_gambit_2d_module();
};


g_bb5_hello_2d_gxjs_2d_rt_23_.id = 4;
g_bb5_hello_2d_gxjs_2d_rt_23_.parent = g_bb1_hello_2d_gxjs_2d_rt_23_;


g_bb1_hello_2d_gxjs_2d_rt_23_.ctrlpts = [g_bb1_hello_2d_gxjs_2d_rt_23_,g_bb2_hello_2d_gxjs_2d_rt_23_,g_bb3_hello_2d_gxjs_2d_rt_23_,g_bb4_hello_2d_gxjs_2d_rt_23_,g_bb5_hello_2d_gxjs_2d_rt_23_];


g_peps["hello-gxjs-rt#"] = g_bb1_hello_2d_gxjs_2d_rt_23_;
g_glo["hello-gxjs-rt#"] = g_bb1_hello_2d_gxjs_2d_rt_23_;

g_bb1_gxjs_23_alert = function () { // entry-point
  if (g_nargs !== 1) {
    return g_wrong_nargs(g_bb1_gxjs_23_alert);
  }
  var foo = (g_r1);
...
g_bb1_gxjs_23_alert.id = 0;
g_bb1_gxjs_23_alert.parent = g_bb1_gxjs_23_alert;
g_bb1_gxjs_23_alert.nfree = -1;
g_bb1_gxjs_23_alert._name = g_make_interned_symbol("gxjs#alert");
g_bb1_gxjs_23_alert.ctrlpts = null;
g_bb1_gxjs_23_alert.info = false;


g_bb1_gxjs_23_alert.ctrlpts = [g_bb1_gxjs_23_alert];


g_peps["gxjs#alert"] = g_bb1_gxjs_23_alert;
g_glo["gxjs#alert"] = g_bb1_gxjs_23_alert;

g_bb1_gxjs_23_console_2e_log = function () { // entry-point
  if (g_nargs !== 1) {
    return g_wrong_nargs(g_bb1_gxjs_23_console_2e_log);
  }
  console.log((g_r1))
  g_r1 = void 0;
  return g_r0;
...
g_bb1_gxjs_23_console_2e_log.id = 0;
g_bb1_gxjs_23_console_2e_log.parent = g_bb1_gxjs_23_console_2e_log;
g_bb1_gxjs_23_console_2e_log.nfree = -1;
g_bb1_gxjs_23_console_2e_log._name = g_make_interned_symbol("gxjs#console.log");
g_bb1_gxjs_23_console_2e_log.ctrlpts = null;
g_bb1_gxjs_23_console_2e_log.info = false;


g_bb1_gxjs_23_console_2e_log.ctrlpts = [g_bb1_gxjs_23_console_2e_log];


g_peps["gxjs#console.log"] = g_bb1_gxjs_23_console_2e_log;
g_glo["gxjs#console.log"] = g_bb1_gxjs_23_console_2e_log;

g_bb1_gxjs_23_gambit_2d_module_2d_name = function () { // entry-point
  if (g_nargs !== 1) {
    return g_wrong_nargs(g_bb1_gxjs_23_gambit_2d_module_2d_name);
  }
  g_r1 = g_r1[0];
  g_r1 = g_r1[0];
  g_r1 = (g_r1).name;
...
g_bb1_gxjs_23_gambit_2d_module_2d_name.id = 0;
g_bb1_gxjs_23_gambit_2d_module_2d_name.parent = g_bb1_gxjs_23_gambit_2d_module_2d_name;
g_bb1_gxjs_23_gambit_2d_module_2d_name.nfree = -1;
g_bb1_gxjs_23_gambit_2d_module_2d_name._name = g_make_interned_symbol("gxjs#gambit-module-name");
g_bb1_gxjs_23_gambit_2d_module_2d_name.ctrlpts = null;
g_bb1_gxjs_23_gambit_2d_module_2d_name.info = false;


g_bb1_gxjs_23_gambit_2d_module_2d_name.ctrlpts = [g_bb1_gxjs_23_gambit_2d_module_2d_name];


g_peps["gxjs#gambit-module-name"] = g_bb1_gxjs_23_gambit_2d_module_2d_name;
g_glo["gxjs#gambit-module-name"] = g_bb1_gxjs_23_gambit_2d_module_2d_name;

g_bb1_gxjs_23_init_2d_gambit_2d_module = function () { // entry-point
  if (g_nargs !== 1) {
    return g_wrong_nargs(g_bb1_gxjs_23_init_2d_gambit_2d_module);
  }
  g_r2 = g_r1[4];
  if (typeof g_r2 === "function") {
    if (--g_pollcount === 0) {
      return g_poll(g_bb3_gxjs_23_init_2d_gambit_2d_module);
    } else {
      g_nargs = 0;
    ...
    g_r2 = g_r1;
    g_r1 = g_cst0_G_hello_2d_gxjs_2d_rt;
    if (--g_pollcount === 0) {
      return g_poll(g_bb5_gxjs_23_init_2d_gambit_2d_module);
    } else {
      g_nargs = 2;
      return g_check_procedure_glo(g_glo["error"],g_cst1_G_hello_2d_gxjs_2d_rt)();
    }
  }
};


g_bb1_gxjs_23_init_2d_gambit_2d_module.id = 0;
g_bb1_gxjs_23_init_2d_gambit_2d_module.parent = g_bb1_gxjs_23_init_2d_gambit_2d_module;
g_bb1_gxjs_23_init_2d_gambit_2d_module.nfree = -1;
g_bb1_gxjs_23_init_2d_gambit_2d_module._name = g_make_interned_symbol("gxjs#init-gambit-module");
g_bb1_gxjs_23_init_2d_gambit_2d_module.ctrlpts = null;
g_bb1_gxjs_23_init_2d_gambit_2d_module.info = false;

g_bb2_gxjs_23_init_2d_gambit_2d_module = function () {
  if (--g_pollcount === 0) {
    return g_poll(g_bb3_gxjs_23_init_2d_gambit_2d_module);
  } else {
    g_nargs = 0;
...
g_bb2_gxjs_23_init_2d_gambit_2d_module.id = 1;
g_bb2_gxjs_23_init_2d_gambit_2d_module.parent = g_bb1_gxjs_23_init_2d_gambit_2d_module;

g_bb3_gxjs_23_init_2d_gambit_2d_module = function () {
  g_nargs = 0;
  return g_check_procedure(g_r2);
};


g_bb3_gxjs_23_init_2d_gambit_2d_module.id = 2;
g_bb3_gxjs_23_init_2d_gambit_2d_module.parent = g_bb1_gxjs_23_init_2d_gambit_2d_module;

g_bb4_gxjs_23_init_2d_gambit_2d_module = function () {
  g_r2 = g_r1;
  g_r1 = g_cst0_G_hello_2d_gxjs_2d_rt;
  if (--g_pollcount === 0) {
    return g_poll(g_bb5_gxjs_23_init_2d_gambit_2d_module);
...
g_bb4_gxjs_23_init_2d_gambit_2d_module.id = 3;
g_bb4_gxjs_23_init_2d_gambit_2d_module.parent = g_bb1_gxjs_23_init_2d_gambit_2d_module;

g_bb5_gxjs_23_init_2d_gambit_2d_module = function () {
  g_nargs = 2;
  return g_check_procedure_glo(g_glo["error"],g_cst1_G_hello_2d_gxjs_2d_rt)();
};


g_bb5_gxjs_23_init_2d_gambit_2d_module.id = 4;
g_bb5_gxjs_23_init_2d_gambit_2d_module.parent = g_bb1_gxjs_23_init_2d_gambit_2d_module;


g_bb1_gxjs_23_init_2d_gambit_2d_module.ctrlpts = [g_bb1_gxjs_23_init_2d_gambit_2d_module,g_bb2_gxjs_23_init_2d_gambit_2d_module,g_bb3_gxjs_23_init_2d_gambit_2d_module,g_bb4_gxjs_23_init_2d_gambit_2d_module,g_bb5_gxjs_23_init_2d_gambit_2d_module];


g_peps["gxjs#init-gambit-module"] = g_bb1_gxjs_23_init_2d_gambit_2d_module;
g_glo["gxjs#init-gambit-module"] = g_bb1_gxjs_23_init_2d_gambit_2d_module;

g_bb1_gxjs_23_init_2d_gambit_2d_program = function () { // entry-point
  if (g_nargs !== 0) {
    return g_wrong_nargs(g_bb1_gxjs_23_init_2d_gambit_2d_program);
  }
  g_r1 = g_glo["##program-descr"][0];
  g_r2 = 1;
  if (--g_pollcount === 0) {
    return g_poll(g_bb3_gxjs_23_init_2d_gambit_2d_program);
  } else {
    return g_bb3_gxjs_23_init_2d_gambit_2d_program();
  }
};


g_bb1_gxjs_23_init_2d_gambit_2d_program.id = 0;
g_bb1_gxjs_23_init_2d_gambit_2d_program.parent = g_bb1_gxjs_23_init_2d_gambit_2d_program;
g_bb1_gxjs_23_init_2d_gambit_2d_program.nfree = -1;
g_bb1_gxjs_23_init_2d_gambit_2d_program._name = g_make_interned_symbol("gxjs#init-gambit-program");
g_bb1_gxjs_23_init_2d_gambit_2d_program.ctrlpts = null;
g_bb1_gxjs_23_init_2d_gambit_2d_program.info = false;

g_bb3_gxjs_23_init_2d_gambit_2d_program = function () {
  g_r3 = g_r1.length;
  if (g_r2 < g_r3) {
    g_r3 = g_r1[g_r2];
    g_stack[g_sp+1] = g_r0;
    ...
    g_sp += 3;
    if (--g_pollcount === 0) {
      return g_poll(g_bb5_gxjs_23_init_2d_gambit_2d_program);
    } else {
      g_r0 = g_bb2_gxjs_23_init_2d_gambit_2d_program;
      g_nargs = 1;
      return g_bb1_gxjs_23_init_2d_gambit_2d_module();
    }
  } else {
...
g_bb3_gxjs_23_init_2d_gambit_2d_program.id = 1;
g_bb3_gxjs_23_init_2d_gambit_2d_program.parent = g_bb1_gxjs_23_init_2d_gambit_2d_program;

g_bb4_gxjs_23_init_2d_gambit_2d_program = function () {
  g_r3 = g_r1[g_r2];
  g_stack[g_sp+1] = g_r0;
  g_stack[g_sp+2] = g_r1;
  g_stack[g_sp+3] = g_r2;
...
g_bb4_gxjs_23_init_2d_gambit_2d_program.id = 2;
g_bb4_gxjs_23_init_2d_gambit_2d_program.parent = g_bb1_gxjs_23_init_2d_gambit_2d_program;

g_bb5_gxjs_23_init_2d_gambit_2d_program = function () {
  g_r0 = g_bb2_gxjs_23_init_2d_gambit_2d_program;
  g_nargs = 1;
  return g_bb1_gxjs_23_init_2d_gambit_2d_module();
};
...
g_bb5_gxjs_23_init_2d_gambit_2d_program.id = 3;
g_bb5_gxjs_23_init_2d_gambit_2d_program.parent = g_bb1_gxjs_23_init_2d_gambit_2d_program;

g_bb2_gxjs_23_init_2d_gambit_2d_program = function () { // return-point
  g_r2 = g_stack[g_sp] + 1;
  g_r1 = g_stack[g_sp-1];
  g_r0 = g_stack[g_sp-2];
  g_sp -= 3;
...
g_bb2_gxjs_23_init_2d_gambit_2d_program.id = 4;
g_bb2_gxjs_23_init_2d_gambit_2d_program.parent = g_bb1_gxjs_23_init_2d_gambit_2d_program;
g_bb2_gxjs_23_init_2d_gambit_2d_program.fs = 3;
g_bb2_gxjs_23_init_2d_gambit_2d_program.link = 1;

g_bb6_gxjs_23_init_2d_gambit_2d_program = function () {
  g_r1 = void 0;
  return g_r0;
};


g_bb6_gxjs_23_init_2d_gambit_2d_program.id = 5;
g_bb6_gxjs_23_init_2d_gambit_2d_program.parent = g_bb1_gxjs_23_init_2d_gambit_2d_program;


g_bb1_gxjs_23_init_2d_gambit_2d_program.ctrlpts = [g_bb1_gxjs_23_init_2d_gambit_2d_program,g_bb3_gxjs_23_init_2d_gambit_2d_program,g_bb4_gxjs_23_init_2d_gambit_2d_program,g_bb5_gxjs_23_init_2d_gambit_2d_program,g_bb2_gxjs_23_init_2d_gambit_2d_program,g_bb6_gxjs_23_init_2d_gambit_2d_program];


g_peps["gxjs#init-gambit-program"] = g_bb1_gxjs_23_init_2d_gambit_2d_program;
g_glo["gxjs#init-gambit-program"] = g_bb1_gxjs_23_init_2d_gambit_2d_program;

g_module_register([[g_make_interned_symbol("hello-gxjs-rt")],[],null,1,g_bb1_hello_2d_gxjs_2d_rt_23_,false]);
