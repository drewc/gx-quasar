...
(define-macro (%AST-e e)
  `(##structure-ref ,e 1 AST::t #f))


(define-macro (%AST-source e)
  `(##structure-ref ,e 2 AST::t #f))
...
(define (test-read-syntax #!optional (in (current-input-port)))
  (let ((e (##read-datum-or-eof (get-readenv in))))
    e))
...
(define-macro (%&context-super ctx)
  `(##structure-ref ,ctx 3 &context::t #f))
(define-macro (%&context-table ctx)
  `(##structure-ref ,ctx 4 &context::t #f))
